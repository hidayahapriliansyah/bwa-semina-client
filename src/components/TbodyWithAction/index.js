...
// yang bawah buatan saya tapi error jadi kayak nampilin data terus
// kita cek
// import React from 'react';
// import Button from '../Button';
// import { useNavigate } from 'react-router-dom';
...
//                   (key) => 
//                     display.indexOf(key) > -1 && (
//                       // tadinya key={index} mungkin karena key index udah dipake mapping diatas jadi gitu dianggp gak unik
//                       <td key={key}>
//                         {key === 'avatar'
//                           ? ( <Image
//                             height={40}
